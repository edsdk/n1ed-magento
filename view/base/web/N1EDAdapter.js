define([
    ...
    tinyMce4Wysiwyg.prototype = {
        ...
        initialize: function (htmlId, config) {
            ...
            includeJS(
                `https://cloud.n1ed.com/cdn/${n1edapi}/n1tinymce.js`,
                document,
                function () {}
            );
        ...
        getSettings: function () {
            ...
            if (this.config["document_base_url"]) {
                settings["document_base_url"] = this.config[
                    "document_base_url"
                ];
            }
        ...
        openFileBrowser: function (o) {
            ...
            require(["mage/adminhtml/browser"], function () {
                MediabrowserUtility.openDialog(wUrl, false, false, typeTitle, {
                    ...
                    targetElementId: self.activeEditor()
                        ? self.activeEditor().id
                        : null,
                });
            });
        },
        ...
        onChangeContent: function () {
            ...
            if (this.config["tab_id"]) {
                ...
                if (
                    $(tab) != undefined &&
                    $(tab).hasClassName("tab-item-link")
                ) {
                    //eslint-disable-line eqeqeq
        ...
        setEnabledStatus: function (enabled) {
            if (this.activeEditor()) {
                this.activeEditor()
                    .getBody()
                    .setAttribute("contenteditable", enabled);
        ...
        decodeDirectives: function (content) {
            var directiveUrl = this.makeDirectiveUrl("%directive%").split(
                    "?"
                )[0], // remove
                // query
                // string
